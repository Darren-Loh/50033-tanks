...
public class GameManager_tutorial : MonoBehaviour
{
    ...
    private void SpawnAllTanks()
    {
        ...
        Instantiate(m_TankPrefabs[1], m_Tanks[1].m_SpawnPoint.position, m_Tanks[1].m_SpawnPoint.rotation) as GameObject;
        m_Tanks[1].m_PlayerNumber = 3;
        m_Tanks[1].SetupTutorialTank();
